...
struct HomeView: View {
    ...
    // No additional bounce settings here; it's now global.
    ...
    // Your genre arrays
    private let fantasyBooks: [FeaturedStory] = [
    ...
    private let adventureBooks: [FeaturedStory] = [
    ...
    private let horrorBooks: [FeaturedStory] = [
    ...
    private let romanceBooks: [FeaturedStory] = [
    ...
    var body: some View {
        NavigationView {
            ZStack {
                ...
                // Standard ScrollView—bounce disabled globally
                ScrollView {
                    VStack(spacing: 24) {
                           ...
                           let lastItem = library.savedStories.last {
                            ...
                            HStack(spacing: 12) {
                                Text(lastItem.title)
                                    .foregroundColor(.white)
                                Button("Continue") {
                                    // Navigate to the last story if desired
                                }
                                .font(.caption).bold()
