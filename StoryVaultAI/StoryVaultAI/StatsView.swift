        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    // Example stats from the library
                    let totalSaved = library.savedStories.count
                    let totalCompleted = library.savedStories.filter { $0.readingProgress == 1.0 }.count
                    
                    statCard(title: "Saved Stories", value: "\(totalSaved)")
                    statCard(title: "Completed Stories", value: "\(totalCompleted)")
